...
namespace Cake.SignClient
{
    ...
    public static partial class SignClientAliases
    {
        ...
        [CakeMethodAlias]
        public static void SignClientZip(this ICakeContext context, SignClientZipSetting settings)
        {
            if (context == null)
            {
            ...
            var runner = new SignClientRunner<SignClientZipSetting>(context.FileSystem, context.Environment, context.ProcessRunner, context.Tools);
