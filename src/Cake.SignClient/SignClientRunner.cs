...
{
    /// <summary>
    /// Base class for all SignClient related tools.
    /// </summary>
    /// <typeparam name="TSettings">The settings type.</typeparam>
    public class SignClientRunner<TSettings>: Tool<TSettings>
        where TSettings : AutoToolSettings, new()
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SignClientRunner{TSettings}"/> class.
        /// </summary>
        /// <param name="fileSystem">The file system.</param>
        /// <param name="environment">The environment.</param>
        /// <param name="processRunner">The process runner.</param>
        /// <param name="tools">The tool locator.</param>
        public SignClientRunner(
        ...
        {
            return new[] { "SignClient.exe", "SignClient" };
        }
        ...
        {
            var path = SignClientResolver.GetSignClientPath(_fileSystem, _environment);
            return path != null
                ? new[] { path }
